  ...
  <div class="wrap">
    ...
    <el-form :model="form" label-width="100px" class="form">
      ...
      <el-form-item label="当前薪资">
        <el-input size="large" class="input" v-model="form.money" placeholder="请输入phone" />
      </el-form-item>
      <el-form-item label="技术栈">
        <el-input size="large" class="input" v-model="form.techStack" placeholder="请输入技术栈" />
      </el-form-item>
      <el-form-item label="学历">
        <el-select size="large" v-model="form.edu" placeholder="please select your zone">
      ...
      <el-button size="large" class="btn" type="primary">查询</el-button>
    </el-form>
  </div>
</template>
